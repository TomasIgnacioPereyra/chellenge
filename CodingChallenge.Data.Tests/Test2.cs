...
using CodingChallenge.Data.Tests;
...
namespace CodingChallenge.Data.Tests
{
    ...
    {
        private List<FormaGeometricaBase> formas { get; set; }
        private FormaGeometricaService service => new FormaGeometricaService();
        [TestCase]
        public void TestResumenListaVacia()
        {
            Formas = new List<FormaGeometricaBase>();

            var reporte = FormaGeometrica.Imprimir(Formas, 1);

            Assert.AreEqual("<h1>Lista vacía de formas!</h1>", reporte);
        }
